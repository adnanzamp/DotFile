...
print_status "  - Zsh as default shell with Oh My Zsh"
print_status "  - Oh My Posh (beautiful prompt themes)"
print_status "  - All aliases including GitHub git shortcuts (gk, gr, gm, etc.)"
...
print_status ""
print_status "Git shortcuts: gk=checkout, gr=rebase, gm=merge, lg=lazygit"
print_status ""
